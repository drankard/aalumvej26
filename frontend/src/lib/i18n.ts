...
const UI = {
  da: {
    ...
    factsHeading: "Praktisk",
    faqHeading: "Ofte stillede spørgsmål",
    fromHouseHeading: "Fra Ålumvej 26",
    sourceNote: "Oplysninger fra",
    houseNav: "Huset",
  ...
  en: {
    ...
    factsHeading: "Practical",
    faqHeading: "Frequently asked questions",
    fromHouseHeading: "From Ålumvej 26",
    sourceNote: "Details from",
    houseNav: "The house",
  ...
  de: {
    ...
    factsHeading: "Praktisches",
    faqHeading: "Häufige Fragen",
    fromHouseHeading: "Von Ålumvej 26",
    sourceNote: "Angaben von",
    houseNav: "Das Haus",
